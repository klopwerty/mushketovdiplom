...
<div class="MAIN">
 ...
 <table border="1" cellpadding="7" cellspacing="0">
        <tr>
            <td width="1920PX" colspan="4" align="center"><b>Все пользователи</td>
        </tr>
...
$sql_select = "SELECT * FROM `users`INNER JOIN positions ON users.position = positions.id WHERE `dismis` is NULL"; /*запрос к БД*/
