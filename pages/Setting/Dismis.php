...
<div class="MAIN">
    ...
    <form action="user/dis_form.php" method="post">
        <fieldset>
            <?php
            ...
            do
            {
                printf("<input type='radio' name='user' value='%s'>%s %s<br/><br/>", $row['users_id'], $row['FIO'],  $row['users_login'],  $row['Dismis']);	
            }
                while($row = mysql_fetch_array($result))
            ?>
        </fieldset>
        <fieldset>
            <input type="submit" class ="back" value="Добавить запись об увольнении ">
        </fieldset>
    </form>
